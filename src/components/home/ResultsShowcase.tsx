 import { ArrowRight, TrendingUp, Shield, Clock, IndianRupee } from "lucide-react";
     ...
     <section className="py-20 bg-background">
       <div className="container mx-auto px-4">
         ...
         <div className="bg-navy rounded-2xl p-8 md:p-12">
           <h3 className="text-2xl font-display font-bold text-cream text-center mb-10">
           ...
           <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
             {testimonials.map((testimonial, index) => (
               <div key={index} className="text-center">
                 ...
                 <div className="text-cream font-semibold">{testimonial.author}</div>
