    ...
    <section className="py-28 bg-gradient-to-br from-navy via-navy-dark to-navy relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          {/* Trust badge */}
          <div className="inline-flex items-center gap-2 px-5 py-2.5 bg-gold/20 rounded-full mb-8 backdrop-blur-sm border border-gold/20">
            <Users className="w-4 h-4 text-gold" />
            <span className="text-cream text-sm font-semibold">9+ Expert CAs Ready to Help</span>
          ...
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-display font-bold text-white mb-6 leading-tight">
            ...
            <span className="text-cream block mt-2">Financial Compliance?</span>
          </h2>
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-10">
            <div className="flex items-center gap-2 px-4 py-2 bg-white/10 rounded-full backdrop-blur-sm">
              ...
              <span className="text-white/80 text-sm">Same-day response</span>
            </div>
            <div className="flex items-center gap-2 px-4 py-2 bg-white/10 rounded-full backdrop-blur-sm">
              <Shield className="w-4 h-4 text-gold" />
              <span className="text-white/80 text-sm">100% Confidential</span>
            </div>
          </div>
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-12">
            <Link
              to="/contact"
              className="bg-gradient-to-r from-gold to-cream text-navy px-10 py-4 rounded-xl font-bold text-lg hover:shadow-2xl transition-all inline-flex items-center gap-2 group hover:-translate-y-0.5"
            >
            ...
            <a
              ...
              className="bg-white/10 text-white px-8 py-4 rounded-xl font-semibold hover:bg-white/20 transition-all border border-white/20 inline-flex items-center gap-2 backdrop-blur-sm"
            >
            ...
            <a
              ...
              className="bg-green-600 text-white px-8 py-4 rounded-xl font-semibold hover:bg-green-500 transition-all inline-flex items-center gap-2 shadow-lg"
            >
          ...
          <div className="flex flex-wrap justify-center gap-8 pt-10 border-t border-white/10">
            <a href="tel:+919825046598" className="flex items-center gap-4 text-white/70 hover:text-cream transition-colors group">
              ...
              <div className="text-left">
                <div className="text-sm text-white/50 font-medium">Call us</div>
                <div className="font-bold text-lg">+91 98250 46598</div>
              </div>
            </a>
            <a href="mailto:info@aky.co.in" className="flex items-center gap-4 text-white/70 hover:text-cream transition-colors group">
              <div className="w-14 h-14 bg-white/10 rounded-xl flex items-center justify-center group-hover:bg-white/20 transition-colors backdrop-blur-sm">
                <Mail className="w-6 h-6 text-gold" />
              </div>
              <div className="text-left">
                <div className="text-sm text-white/50 font-medium">Email us</div>
                <div className="font-bold text-lg">info@aky.co.in</div>
              </div>
            </a>
            <div className="flex items-center gap-4 text-white/70">
              ...
              <div className="text-left">
                <div className="text-sm text-white/50 font-medium">Office hours</div>
                <div className="font-bold text-lg">Mon-Sat, 10AM-7PM</div>
              </div>
            </div>
          </div>
        </div>
