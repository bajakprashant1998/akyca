...
const services = [
  { title: "Risk Assessment & Internal Controls", description: "Comprehensive assessment of business risks and internal control systems.", features: ["Risk mapping", "Control evaluation", "Gap analysis", "Remediation roadmap"], process: ["Assessment", "Evaluation", "Reporting", "Implementation"], benefits: ["Risk mitigation", "Fraud prevention", "Efficiency", "Compliance"], link: "/services/advanced/risk-assessment" },
  { title: "Forensic Audit & Fraud Investigation", description: "Specialized investigations into suspected fraud and financial irregularities.", features: ["Fraud detection", "Digital evidence", "Investigation reporting", "Litigation support"], process: ["Investigation planning", "Evidence gathering", "Analysis", "Reporting"], benefits: ["Fraud detection", "Legal evidence", "Recovery support", "Prevention"], link: "/services/advanced/forensic-audit" },
  { title: "Business Valuation", description: "Independent business valuations using multiple methodologies.", features: ["DCF valuation", "Comparable analysis", "Asset-based valuation", "Fairness opinions"], process: ["Scope definition", "Data analysis", "Valuation", "Certification"], benefits: ["Independent opinion", "Multi-method", "Regulatory accepted", "Expert support"], link: "/services/advanced/business-valuation" },
  { title: "Insolvency & Bankruptcy (IBC) Support", description: "Comprehensive support under the Insolvency and Bankruptcy Code.", features: ["CIRP support", "Claims verification", "Resolution advisory", "Liquidation support"], process: ["Assessment", "Claims filing", "Resolution", "Closure"], benefits: ["Expert guidance", "Recovery maximization", "Compliance", "Timely resolution"], link: "/services/advanced/ibc-support" },
  { title: "Turnaround & Restructuring Advisory", description: "Strategic advisory for distressed businesses.", features: ["Viability assessment", "Cash flow restructuring", "Debt restructuring", "Operational improvement"], process: ["Diagnosis", "Strategy", "Implementation", "Monitoring"], benefits: ["Business revival", "Stakeholder confidence", "Improved performance", "Expert support"], link: "/services/advanced/turnaround-restructuring" },
  { title: "Corporate Governance Advisory", description: "Advisory to strengthen corporate governance practices.", features: ["Governance framework", "Board advisory", "Policy formulation", "ESG integration"], process: ["Assessment", "Framework design", "Implementation", "Monitoring"], benefits: ["Better governance", "Stakeholder trust", "Risk management", "Compliance"], link: "/services/advanced/corporate-governance" }
];
