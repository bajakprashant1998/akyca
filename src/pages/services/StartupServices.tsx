...
const services = [
  { title: "Startup India & DPIIT Registration", description: "Complete assistance with Startup India registration for tax benefits and government incentives.", features: ["DPIIT recognition", "Tax exemption certification", "Startup India portal", "Government schemes"], process: ["Eligibility check", "Documentation", "Application", "Certification"], benefits: ["Tax benefits", "Easy compliance", "Funding access", "Government support"], link: "/services/startup/dpiit-registration" },
  { title: "Angel Tax Advisory", description: "Expert guidance on Section 56(2)(viib) compliance and valuation.", features: ["Share valuation", "Exemption filing", "Documentation", "Notice handling"], process: ["Valuation", "Exemption application", "Filing", "Compliance"], benefits: ["Tax savings", "Investor confidence", "Legal compliance", "Expert support"], link: "/services/startup/angel-tax-advisory" },
  { title: "ESOP Structuring", description: "Design and implementation of Employee Stock Option Plans.", features: ["Scheme drafting", "Trust creation", "Vesting design", "Tax guidance"], process: ["Design", "Documentation", "Implementation", "Ongoing support"], benefits: ["Talent retention", "Motivation", "Tax efficiency", "Scalable"], link: "/services/startup/esop-structuring" },
  { title: "Business Plan & Financial Modelling", description: "Professional business plan preparation and financial modeling.", features: ["Market analysis", "Revenue projections", "Expense forecasting", "Sensitivity analysis"], process: ["Research", "Modeling", "Validation", "Presentation"], benefits: ["Investor ready", "Clear roadmap", "Data-driven", "Professional"], link: "/services/startup/business-planning" },
  { title: "Pitch Deck Support", description: "Creating compelling investor pitch decks.", features: ["Story development", "Financial slides", "Metrics", "Q&A prep"], process: ["Story crafting", "Design", "Review", "Practice"], benefits: ["Higher conversions", "Professional", "Compelling", "Investor focus"], link: "/services/startup/pitch-deck-support" },
  { title: "Seed, Angel & VC Funding Support", description: "End-to-end support for fundraising rounds.", features: ["Investor outreach", "Due diligence", "Term negotiation", "Documentation"], process: ["Preparation", "Outreach", "Negotiation", "Closure"], benefits: ["Better valuations", "Faster closure", "Better terms", "Expert support"], link: "/services/startup/funding-support" }
];
